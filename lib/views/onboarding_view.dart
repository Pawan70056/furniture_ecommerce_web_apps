...
import 'package:funiture_ecommerce/widgets/onboarding_indicator.dart';
              ...
              children: [
                TextButton(
                  ...
                  child: Text(
                    "Skip",
                    style: TextStyle(
                        color: Theme.of(context).hintColor), // Use hintColor
                  ),
                ),
                ElevatedButton(
                  style: ElevatedButton.styleFrom(
                    backgroundColor:
                        Theme.of(context).hintColor, // Use hintColor for button
                  ),
                  onPressed: () {
