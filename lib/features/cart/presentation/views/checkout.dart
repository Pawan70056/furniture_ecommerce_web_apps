...
import 'package:furniture_shopping_ecommerce/core/colors/colors.dart';
import 'package:furniture_shopping_ecommerce/core/utilities/mediaquery.dart';
import 'package:furniture_shopping_ecommerce/core/utilities/strings.dart';
import 'package:furniture_shopping_ecommerce/features/cart/presentation/bloc/cart_bloc.dart';
import 'package:furniture_shopping_ecommerce/features/cart/presentation/bloc/location_bloc.dart';
import 'package:furniture_shopping_ecommerce/features/cart/presentation/widgets/deliverymethod_card.dart';
import 'package:furniture_shopping_ecommerce/features/cart/presentation/widgets/mappreview.dart';
import 'package:furniture_shopping_ecommerce/features/login/presentation/widgets/alert_snackbar.dart';
import 'package:furniture_shopping_ecommerce/features/login/presentation/widgets/maintextformfield.dart';
import 'package:furniture_shopping_ecommerce/features/payment/presentation/bloc/order_bloc.dart';
import 'package:furniture_shopping_ecommerce/features/profile/presentation/bloc/profile_bloc.dart';
...
class _AddNewAddressViewState extends State<AddNewAddressView> {
  ...
  CountryCode? countryFlag = const CountryCode(
    name: 'Egypt',
    code: 'EG',
    dialCode: '+20',
  );
            ...
            builder: (context, state) {
              return state is Paymentloading || state is CreateOrderLoading
                  ...
                  : FloatingActionButton.extended(
                      ...
                      if (formKey.currentState!.validate()) {
                        BlocProvider.of<PaymentBloc>(context).add(
                          RequestPayment(
                            ...
                            BlocProvider.of<LocationBloc>(
                              context,
                            ).currentAddress![0].locality!,
                            BlocProvider.of<LocationBloc>(
                              context,
                            ).currentAddress![0].country!,
                            BlocProvider.of<LocationBloc>(
                              context,
                            ).currentAddress![0].subAdministrativeArea!,
                    ...
                    label: Text(AppStrings.submitOrder.toUpperCase()),
                  );
            },
          ),
        ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '${BlocProvider.of<CartBloc>(context).totalAmount} \Rs',
                                  style:
                                      Theme.of(context).textTheme.headlineSmall,
                                ),
                              ],
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '${BlocProvider.of<LocationBloc>(context).delivery} \Rs',
                                  style:
                                      Theme.of(context).textTheme.headlineSmall,
                                ),
                              ],
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '${BlocProvider.of<CartBloc>(context).totalAmount + BlocProvider.of<LocationBloc>(context).delivery} \Rs',
                                  style:
                                      Theme.of(context).textTheme.headlineSmall,
                                ),
                              ],
