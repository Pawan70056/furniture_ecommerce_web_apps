...
import 'package:furniture_shopping_ecommerce/core/utilities/routes.dart';
...
import 'package:furniture_shopping_ecommerce/features/cart/presentation/widgets/cart_item.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton:
          BlocProvider.of<CartBloc>(context).cartItems.isEmpty
              ? const SizedBox()
              : SizedBox(
