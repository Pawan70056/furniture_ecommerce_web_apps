...
import 'package:furniture_shopping_ecommerce/features/shop/presentation/bloc/send_review_bloc.dart';
import 'package:furniture_shopping_ecommerce/features/shop/presentation/widgets/review_card.dart';
  ...
  void animateCartAdd(BuildContext contextRenderBox, ImageProvider image) {
    var overlayEntry = OverlayEntry(
      builder: (context) {
        ...
        if (box != null) {
          var startOffset = box.localToGlobal(
            Offset(kWidth(context) / 4, kWidth(context) / 4),
          );
          ...
          var animatedOffset = Tween<Offset>(
            begin: startOffset,
            end: endOffset,
      ...
      floatingActionButton: SizedBox(
        ...
        child: FloatingActionButton.extended(
          ...
          onPressed: () {
            ...
            animateCartAdd(context, NetworkImage(widget.product.images[0].url));
          },
          label: BlocConsumer<CartBloc, CartState>(
            ...
            builder: (context, state) {
              return Text(AppStrings.addToCart.toUpperCase());
            },
          ),
        ),
      ),
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        ...
                        BlocProvider.of<SendReviewBloc>(
                          context,
              ...
              SizedBox(height: kHeight(context) / 11),
            ],
          ),
        ),
      ),
